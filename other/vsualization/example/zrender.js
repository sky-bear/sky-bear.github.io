(function (global, factory) {
        ...
        if (_ctx) {
          ...
          if (font.indexOf("mono") >= 0) {
            ...
            for (var i = 0; i < text.length; i++) {
              ...
              width +=
                preCalcWidth == null ? fontSize : preCalcWidth * fontSize;
            }
          }
          return { width: width };
        }
  ...
  var firefoxNotSupportOffsetXY =
    env.browser.firefox && +env.browser.version.split(".")[0] < 39;
  ...
  var BoundingRect = (function () {
    ...
    BoundingRect.intersect = function (a, b, mtv, opt) {
      ...
      if (outIntersectRect) {
        outIntersectRect.x =
          outIntersectRect.y =
          outIntersectRect.width =
          outIntersectRect.height =
            NaN;
      }
      if (!a || !b) {
        return false;
      ...
      if (useMTV || outIntersectRect) {
        ...
        if (useMTV) {
          Point.copy(
            mtv,
            overlap
              ? _intersectCtx.useDir
                ? _intersectCtx.dirMinTv
                : _minTv
              : _maxTv
          );
        }
  ...
  function createIntersectContext() {
    ...
    var _ctx = {
      ...
      calcDirMTV: function () {
        ...
        if (
          (_ctx.bidirectional || _dirCheckVec.dot(_dirTmp) > 0) &&
  ...
  var Handler = (function (_super) {
    ...
    Handler.prototype.dispatchToElement = function (
      targetInfo,
      eventName,
      event
    ) {
    ...
    Handler.prototype.findHover = function (x, y, exclude) {
      ...
      if (this._pointerSize && !out.target) {
        ...
        var pointerRect = new BoundingRect(
          x - targetSizeHalf,
          y - targetSizeHalf,
          pointerSize,
          pointerSize
  ...
  var Storage = (function () {
    ...
    Storage.prototype._updateAndAddDisplayable = function (
      el,
      parentClipPaths,
      includeIgnore
    ) {
    ...
    if (cubic) {
      ...
      return function (p) {
        return p <= 0
          ...
          : p >= 1
          ? 1
          : cubicRootAt(0, a_1, c_1, 1, p, roots_1) &&
  ...
  function modifyHSL(color, h, s, l) {
    ...
    if (color) {
      ...
      s != null &&
        (colorArr[1] = parseCssFloat(isFunction(s) ? s(colorArr[1]) : s));
      l != null &&
        (colorArr[2] = parseCssFloat(isFunction(l) ? l(colorArr[2]) : l));
  ...
  function hasShadow(style) {
    return (
      style && (style.shadowBlur || style.shadowOffsetX || style.shadowOffsetY)
    );
  }
  ...
  function getSRTTransformString(transform) {
    ...
    if (skewX || skewY) {
      res.push(
        "skew(" +
          mathRound(skewX * RADIAN_TO_DEGREE) +
          "deg, " +
          mathRound(skewY * RADIAN_TO_DEGREE) +
          "deg)"
      );
    }
    return res.join(" ");
  ...
  var Track = (function () {
    ...
    Track.prototype.step = function (target, percent) {
      ...
      var w =
        interval === 0 ? 1 : mathMin((percent - frame.percent) / interval, 1);
        ...
        target[propName] = {
          ...
          colorStops: map(val.colorStops, function (colorStop, idx) {
            ...
            return {
              ...
              color: rgba2String(
                interpolate1DArray([], colorStop.color, nextColorStop.color, w)
              ),
            };
          }),
  ...
  var Animator = (function () {
    ...
    Animator.prototype.whenWithKeys = function (
      time,
      props,
      propNames,
      easing
  ...
  function isLocalEl(instance, el) {
    ...
    while (
      ...
      elTmp.nodeType !== 9 &&
      !(isLocal =
        elTmp.domBelongToZr || (elTmp !== el && elTmp === instance.painterRoot))
    ) {
  ...
  var HandlerDomProxy = (function (_super) {
    ...
    HandlerDomProxy.prototype.__togglePointerCapture = function (
      isPointerCapturing
    ) {
  ...
  function tryCreateASCIIWidthMap(font) {
    ...
    for (var code = 0; code <= 127; code++) {
      asciiWidthMap[code] = platformApi.measureText(
  ...
  function measureCharWidth(fontMeasureInfo, charCode) {
    if (!fontMeasureInfo.asciiWidthMapTried) {
      fontMeasureInfo.asciiWidthMap = tryCreateASCIIWidthMap(
        fontMeasureInfo.font
      );
  ...
  var Element = (function () {
    ...
    Element.prototype.getOutsideStroke = function (textFill) {
      ...
      var colorArr =
        typeof backgroundColor === "string" && parse(backgroundColor);
      if (!colorArr) {
    ...
    Element.prototype.saveCurrentToNormalState = function (toState) {
      ...
      for (var i = 0; i < this.animators.length; i++) {
        ...
        if (
          animator.getLoop() ||
          (fromStateTransition &&
            fromStateTransition !== PRESERVED_NORMAL_STATE)
        ) {
          continue;
        }
    ...
    Element.prototype._savePrimaryToNormal = function (
      toState,
      normalState,
      primaryKeys
    ) {
    ...
    Element.prototype.useState = function (
      stateName,
      keepCurrentStates,
      noAnimation,
      forceUseHoverLayer
    ...
    Element.prototype.useStates = function (
      states,
      noAnimation,
      forceUseHoverLayer
    ) {
    ...
    Element.prototype._applyStateObj = function (
      stateName,
      state,
      normalState,
      keepCurrentStates,
    ...
    Element.prototype.animate = function (key, loop, allowDiscreteAnimation) {
      var target = key ? this[key] : this;
      {
        if (!target) {
          logError(
            'Property "' + key + '" is not existed in element ' + this.id
          );
          return;
        }
      }
    ...
    Element.prototype._transitionState = function (
      stateName,
      target,
      cfg,
      animationProps
  ...
  function animateToShallow(
    ...
    if (keyLen > 0 || (cfg.force && !animators.length)) {
      ...
      var animator = new Animator(
        ...
        false,
        additive
          ? filter(existsAnimators, function (animator) {
  ...
  var Displayable = (function (_super) {
    ...
    Displayable.prototype.shouldBePainted = function (
      viewWidth,
      viewHeight,
      considerClipPath,
      considerAncestors
    ...
    Displayable.prototype.getPaintRect = function () {
      ...
      if (!this._paintRect || this.__dirty) {
        ...
        rect =
          this._paintRect || (this._paintRect = new BoundingRect(0, 0, 0, 0));
        if (transform) {
    ...
    Displayable.prototype._applyStateObj = function (
      stateName,
      state,
      normalState,
      keepCurrentStates,
      ...
      if (targetStyle) {
        if (transition) {
          ...
          this.style = this.createStyle(
            needsRestoreToNormal ? {} : sourceStyle
          );
  ...
  function normalizeArcAngles(angles, anticlockwise) {
    ...
    if (!anticlockwise && newEndAngle - newStartAngle >= PI2$1) {
      ...
      newEndAngle =
        newStartAngle + (PI2$1 - modPI2(newStartAngle - newEndAngle));
    } else if (anticlockwise && newStartAngle < newEndAngle) {
      newEndAngle =
        newStartAngle - (PI2$1 - modPI2(newEndAngle - newStartAngle));
    }
  ...
  var PathProxy = (function () {
    ...
    PathProxy.prototype.setScale = function (sx, sy, segmentIgnoreThreshold) {
      ...
      if (segmentIgnoreThreshold > 0) {
        this._ux =
          mathAbs$1(segmentIgnoreThreshold / devicePixelRatio / sx) || 0;
        this._uy =
          mathAbs$1(segmentIgnoreThreshold / devicePixelRatio / sy) || 0;
      }
    };
        ...
        switch (cmd) {
          ...
          case CMD.A:
            ...
            if (drawPart) {
              ...
              if (accumLength + l > displayedLength) {
                endAngle =
                  startAngle + (delta * (displayedLength - accumLength)) / l;
                breakBuild = true;
              }
              accumLength += l;
            }
  ...
  var Path = (function (_super) {
    ...
    Path.prototype._applyStateObj = function (
      stateName,
      state,
      normalState,
      keepCurrentStates,
  ...
  function processArc(x1, y1, x2, y2, fa, fs, rx, ry, psiDeg, cmd, path) {
    ...
    var xp =
      (mathCos$2(psi) * (x1 - x2)) / 2.0 + (mathSin$2(psi) * (y1 - y2)) / 2.0;
    var yp =
      (-1 * mathSin$2(psi) * (x1 - x2)) / 2.0 +
  ...
  var Rect = (function (_super) {
    ...
    Rect.prototype.buildPath = function (ctx, shape) {
      ...
      if (this.subPixelOptimize) {
        var optimizedShape = subPixelOptimizeRect(
  ...
  var Line = (function (_super) {
    ...
    Line.prototype.buildPath = function (ctx, shape) {
      ...
      var y2;
      if (this.subPixelOptimize) {
        var optimizedShape = subPixelOptimizeLine(
  ...
  function prepareTruncateOptions(containerWidth, font, ellipsis, options) {
    ...
    var fontMeasureInfo = (preparedOpts.fontMeasureInfo =
      ensureFontMeasureInfo(font));
  ...
  function parsePlainText(
    ...
    for (var i = 0; i < lines.length; i++) {
      contentWidth = Math.max(
        measureWidth(fontMeasureInfo, lines[i]),
        contentWidth
      );
    }
    if (width == null) {
  ...
  function parseRichText(
    ...
    outer: for (var i = 0; i < contentBlock.lines.length; i++) {
      ...
      for (var j = 0; j < line.tokens.length; j++) {
        ...
        token.verticalAlign =
          (tokenStyle && tokenStyle.verticalAlign) || "middle";
        if (
          truncateLine &&
          topHeight != null &&
          ...
          contentBlock.isTruncated =
            contentBlock.isTruncated ||
            contentBlock.lines.length < originalLength;
          break outer;
        }
        ...
        if (
          ...
          token.contentWidth = measureWidth(
            ensureFontMeasureInfo(font),
            token.text
          );
        } else {
          ...
          if (remainTruncWidth != null && remainTruncWidth < token.width) {
            if (!tokenWidthNotSpecified || remainTruncWidth < paddingH) {
              ...
              contentBlock.isTruncated =
                contentBlock.isTruncated || tmpTruncateOut.isTruncated;
              token.width = token.contentWidth = measureWidth(
                ensureFontMeasureInfo(font),
                token.text
              );
            }
  ...
  function pushTokens(block, str, style, wrapInfo, styleName) {
    ...
    if (wrapInfo) {
      ...
      if (tokenStyle.width != null && tokenStyle.width !== "auto") {
        var outerWidth_1 =
          parsePercent(tokenStyle.width, wrapInfo.width) + tokenPaddingH;
        if (lines.length > 0) {
    ...
    for (var i = 0; i < strLines.length; i++) {
      ...
      if (!i && !newLine) {
        var tokens = (
          lines[lines.length - 1] || (lines[0] = new RichTextLine())
        ).tokens;
  ...
  function calcInnerTextOverflowArea(
    out,
    overflowRect,
    baseX,
    baseY,
    ...
    BoundingRect.set(
      ...
      adjustTextY$1(baseY, textHeight, textVerticalAlign),
      textWidth,
      textHeight
    );
    BoundingRect.intersect(
      overflowRect,
      tmpCITCTextRect,
      null,
      tmpCITCIntersectRectOpt
    );
    ...
    out.baseX = adjustTextX(
      outIntersectRect.x,
      outIntersectRect.width,
      textAlign,
      true
    );
    out.baseY = adjustTextY$1(
      outIntersectRect.y,
      outIntersectRect.height,
      textVerticalAlign,
      true
  ...
  function tSpanCreateBoundingRect2(
    style,
    contentWidth,
    contentHeight,
    forceLineWidth
    ...
    var rect = new BoundingRect(
      adjustTextX(style.x || 0, contentWidth, style.textAlign),
      adjustTextY$1(style.y || 0, contentHeight, style.textBaseline),
      contentWidth,
      contentHeight
    );
    var lineWidth =
  ...
  var INHERITABLE_STYLE_ATTRIBUTES_MAP_KEYS = keys(
  ...
  var SVGParser = (function () {
    ...
    SVGParser.prototype._parseNode = function (
      xmlNode,
      parentGroup,
      named,
      namedFrom,
    ...
    SVGParser.internalField = (function () {
      nodeParsers = {
        ...
        image: function (xmlNode, parentGroup) {
          ...
          img.setStyle({
            image:
              xmlNode.getAttribute("xlink:href") ||
              xmlNode.getAttribute("href"),
  ...
  function parseGradientColorStops(xmlNode, gradient) {
    ...
    while (stop) {
      if (stop.nodeType === 1 && stop.nodeName.toLocaleLowerCase() === "stop") {
        ...
        var stopColor =
          styleVals.stopColor || stop.getAttribute("stop-color") || "#000000";
        var stopOpacity =
          styleVals.stopOpacity || stop.getAttribute("stop-opacity");
        if (stopOpacity) {
  ...
  function parseInlineStyle(xmlNode, inheritableStyleResult, selfStyleResult) {
    ...
    while ((styleRegResult = styleRegex.exec(style)) != null) {
      ...
      var zrInheritableStlAttr = hasOwn(
        INHERITABLE_STYLE_ATTRIBUTES_MAP,
        svgStlAttr
      )
  ...
  function makeViewBoxTransform(viewBoxRect, boundingRect) {
    ...
    return {
      scale: scale,
      x:
        -(viewBoxRect.x + viewBoxRect.width / 2) * scale +
        (boundingRect.x + boundingRect.width / 2),
      y:
        -(viewBoxRect.y + viewBoxRect.height / 2) * scale +
  ...
  function buildPath$2(ctx, shape) {
    ...
    if (!(radius > e)) {
      ...
      ctx.moveTo(
        cx + radius * mathCos$3(startAngle),
        cy + radius * mathSin$3(startAngle)
      );
      ctx.arc(cx, cy, radius, startAngle, endAngle, !clockwise);
      if (innerRadius > e) {
        ctx.moveTo(
          cx + innerRadius * mathCos$3(endAngle),
          cy + innerRadius * mathSin$3(endAngle)
        );
            ...
            if (it_1) {
              ...
              var a =
                ...
                mathSin$3(
                  mathACos(
                    (x0 * x1 + y0 * y1) /
                      (mathSqrt$3(x0 * x0 + y0 * y0) *
                        mathSqrt$3(x1 * x1 + y1 * y1))
                  ) / 2
                );
  ...
  function split(path, count) {
    ...
    switch (path.type) {
      ...
      default:
        ...
        var scale = m
          ? Math.sqrt(
              Math.max(m[0] * m[0] + m[1] * m[1], m[2] * m[2] + m[3] * m[3])
            )
          : 1;
        var polygons = map(
  ...
  function findBestMorphingRotation(
    ...
    for (var i = 0; i < fromArr.length; i++) {
      ...
      var offset =
        findBestRingOffset(fromSubpathBezier, toSubpathBezier, fromCp, toCp) *
        6;
      var len2 = len - 2;
          ...
          ? defaults(
              {
                delay:
                  ...
                  individualDelay(i, toLen, fromPathList[i], toSubPathList[i]),
                done: eachDone,
              },
              animationOpts
            )
        ...
        ? defaults(
            {
              delay:
                (animationOpts.delay || 0) +
                individualDelay(i, toLen, fromPathList[i], toPathList[i]),
            },
            animationOpts
          )
        : animationOpts;
  ...
  var IncrementalDisplayable = (function (_super) {
    ...
    IncrementalDisplayable.prototype.addDisplayable = function (
      displayable,
      notPersistent
    ) {
      if (notPersistent) {
    ...
    IncrementalDisplayable.prototype.addDisplayables = function (
      displayables,
      notPersistent
    ) {
  ...
  var ZRText = (function (_super) {
    ...
    ZRText.prototype._updatePlainTexts = function () {
      ...
      var verticalAlign =
        style.verticalAlign || defaultStyle.verticalAlign || "top";
      calcInnerTextOverflowArea(
        tmpCITOverflowAreaOut,
        defaultStyle.overflowRect,
        baseX,
        baseY,
        textAlign,
        verticalAlign
      ...
      var textX = baseX;
      var textY = adjustTextY$1(
        baseY,
        contentBlock.contentHeight,
        verticalAlign
      );
    ...
    ZRText.prototype._placeToken = function (
      token,
      style,
      lineHeight,
      lineTop,
      ...
      if (hasShadow) {
        subElStyle.shadowBlur =
          tokenStyle.textShadowBlur || style.textShadowBlur || 0;
        subElStyle.shadowColor =
          tokenStyle.textShadowColor || style.textShadowColor || "transparent";
        subElStyle.shadowOffsetX =
          tokenStyle.textShadowOffsetX || style.textShadowOffsetX || 0;
        subElStyle.shadowOffsetY =
          tokenStyle.textShadowOffsetY || style.textShadowOffsetY || 0;
      }
      subElStyle.textAlign = textAlign;
      subElStyle.textBaseline = "middle";
    ...
    ZRText.prototype._renderBackground = function (
      style,
      topStyle,
      x,
      y,
  ...
  function normalizeStyle(style) {
    if (style) {
      ...
      style.align =
        textAlign == null || VALID_TEXT_ALIGN[textAlign] ? textAlign : "left";
    ...
    Rose.prototype.buildPath = function (ctx, shape) {
      ...
      for (var i = 0, len = R.length; i < len; i++) {
        ...
        for (var j = 0; j <= 360 * n; j++) {
          x =
            r * sin$1((((k / n) * j) % 360) * radian) * cos$1(j * radian) + x0;
          y =
            r * sin$1((((k / n) * j) % 360) * radian) * sin$1(j * radian) + y0;
          ctx.lineTo(x, y);
        }
      }
    };
  ...
  var OrientedBoundingRect = (function () {
    ...
    OrientedBoundingRect.prototype.fromBoundingRect = function (
      rect,
      transform
    ) {
    ...
    OrientedBoundingRect.prototype.intersect = function (other, mtv, opt) {
      ...
      if (!noMtv && !_intersectCtx$1.negativeSize) {
        Point.copy(
          mtv,
          overlapped
            ? _intersectCtx$1.useDir
              ? _intersectCtx$1.dirMinTv
              : _minTv$1
            : _maxTv$1
        );
      }
    ...
    OrientedBoundingRect.prototype._intersectCheckOneSide = function (
      self,
      other,
      noMtv,
      inverse
      ...
      for (var i = 0; i < 2; i++) {
        ...
        if (
          _intersectCtx$1.negativeSize ||
          _extent[1] < _extent2[0] ||
          _extent[0] > _extent2[1]
        ) {
          overlapped = false;
          ...
          if (
            _intersectCtx$1.useDir ||
            mathMin$4(dist0, dist1) < _minTv$1.len()
          ) {
    ...
    OrientedBoundingRect.prototype._getProjMinMaxOnAxis = function (
      dim,
      corners,
      out
    ) {
  ...
  function brush(ctx, el, scope, isLast) {
    ...
    var canBatchPath =
      el instanceof Path && el.autoBatch && canPathBatch(el.style);
  ...
  var Layer = (function (_super) {
    ...
    Layer.prototype.createRepaintRects = function (
      ...
      for (var i = this.__prevStartIndex; i < this.__prevEndIndex; ++i) {
        var el = prevList[i];
        var shouldPaint =
          el && el.shouldBePainted(viewWidth, viewHeight, true, true);
      ...
      function doClear(x, y, width, height) {
        ...
        if (clearColor && clearColor !== "transparent") {
          ...
          if (isGradientObject(clearColor)) {
            var shouldCache =
              clearColor.global ||
              (clearColor.__width === width && clearColor.__height === height);
  ...
  var SVGPathRebuilder = (function () {
    ...
    SVGPathRebuilder.prototype.arc = function (
      cx,
      cy,
      r,
      startAngle,
    ...
    SVGPathRebuilder.prototype.ellipse = function (
      cx,
      cy,
      rx,
      ry,
      ...
      var isCircle =
        isAroundZero$1(dThetaPositive - PI2$6) ||
      ...
      if (isCircle) {
        ...
        this._add(
          ...
          1,
          +clockwise,
          cx + rx * mathCos$4(startAngle + dTheta_1),
          cy + ry * mathSin$4(startAngle + dTheta_1)
        );
        if (p > 1e-2) {
      ...
      return (
        ...
        map(keys(animationNodes[animationName]), function (percent) {
          return (
            ...
            bracketBegin +
            map(
              keys(animationNodes[animationName][percent]),
              function (attrName) {
  ...
  function createCSSAnimation(el, attrs, scope, onlyShape) {
    ...
    function createSingleCSSAnimation(groupAnimator) {
      ...
      if (
        filter(percents, function (percent) {
  ...
  function createCSSEmphasis(el, attrs, scope) {
    if (!el.ignore) {
      if (el.isSilent()) {
        ...
        var emphasisStyle =
          el.states.emphasis && el.states.emphasis.style
        ...
        if (!fill) {
          ...
          var fromFill =
            el.currentStates.indexOf("select") >= 0
        ...
        if (lineWidth) {
          var scaleX =
            !emphasisStyle.strokeNoScale && el.transform ? el.transform[0] : 1;
